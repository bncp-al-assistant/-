...
async function openWelfareModal() {
  document.getElementById('welfareModal').style.display = 'flex';
  document.getElementById('welfareSearchInput').value = '';
  document.getElementById('welfareGrid').innerHTML = '<p style="color:#9aa0a6; grid-column: 1 / -1;">불러오는 중...</p>';
  await loadWelfareData();
